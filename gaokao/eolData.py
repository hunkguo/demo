    ...
    for school in schoolList:
        ...
        for province in provinceList:
            ...
            # for recruit_type in range(1,2):
                for i in range(1,10):
                # for i in range(1,2):
                    for yeraNumber in range(2020,2014,-1):
                        # url = 'https://static-data.eol.cn/www/2.0/schoolspecialindex/{}/{}/13/{}/{}.json'.format(yeraNumber, schoolId,provinceId,recruit_type,i)
                        url = 'https://static-data.eol.cn/www/2.0/schoolspecialindex/{}/{}/{}/{}/{}.json'.format(yeraNumber, schoolId,provinceId,recruit_type,i)
                        url_list.append(url)
    return url_list
